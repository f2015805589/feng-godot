...
// Renderer-local deferred paths may replace only the material/BxDF evaluation while
// retaining this file's clustered light lookup, attenuation and shadow traversal.
