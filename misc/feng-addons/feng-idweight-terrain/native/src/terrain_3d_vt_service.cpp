...
// Surface virtual texture service, part 1 of 3: the views and the settings.

// One of three files that define the service's entry points. The two views' setup and teardown
...
//
// The other halves: `terrain_3d_vt_svt.cpp` (the far field's demand pass) and
