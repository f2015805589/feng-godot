...
class Terrain3DTextureAsset : public Terrain3DAssetResource {
	...
	real_t _slope_based_normal_damp = 0.0f;
...
public:
	...
	void set_slope_blend_sharpness(const real_t p_slope_blend_sharpness);
	real_t get_slope_blend_sharpness() const { return _slope_blend_sharpness; }

	void set_slope_based_damp(const real_t p_slope_based_damp);
	real_t get_slope_based_damp() const { return _slope_based_damp; }

	void set_slope_based_normal_damp(const real_t p_slope_based_normal_damp);
	real_t get_slope_based_normal_damp() const { return _slope_based_normal_damp; }
