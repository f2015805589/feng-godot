...
void Terrain3DTextureAsset::clear() {
	...
	_slope_blend_sharpness = 1000.0f;
	_slope_based_damp = 0.0f;
	_slope_based_normal_damp = 0.0f;
}
...
void Terrain3DTextureAsset::set_slope_blend_sharpness(const real_t p_slope_blend_sharpness) {
	SET_IF_DIFF(_slope_blend_sharpness, CLAMP(p_slope_blend_sharpness, 0.0f, 1000.0f));
	LOG(INFO, "Setting slope_blend_sharpness: ", _slope_blend_sharpness);
	LOG(DEBUG, "Emitting setting_changed");
	emit_signal("setting_changed");
}

void Terrain3DTextureAsset::set_slope_based_damp(const real_t p_slope_based_damp) {
	SET_IF_DIFF(_slope_based_damp, CLAMP(p_slope_based_damp, 0.0f, 1000.0f));
	LOG(INFO, "Setting slope_based_damp: ", _slope_based_damp);
	LOG(DEBUG, "Emitting setting_changed");
	emit_signal("setting_changed");
}

void Terrain3DTextureAsset::set_slope_based_normal_damp(const real_t p_slope_based_normal_damp) {
	SET_IF_DIFF(_slope_based_normal_damp, CLAMP(p_slope_based_normal_damp, 0.0f, 1000.0f));
	LOG(INFO, "Setting slope_based_normal_damp: ", _slope_based_normal_damp);
	LOG(DEBUG, "Emitting setting_changed");
	emit_signal("setting_changed");
}
...
void Terrain3DTextureAsset::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_slope_blend_sharpness", "slope_blend_sharpness"), &Terrain3DTextureAsset::set_slope_blend_sharpness);
	ClassDB::bind_method(D_METHOD("get_slope_blend_sharpness"), &Terrain3DTextureAsset::get_slope_blend_sharpness);
	ClassDB::bind_method(D_METHOD("set_slope_based_damp", "slope_based_damp"), &Terrain3DTextureAsset::set_slope_based_damp);
	ClassDB::bind_method(D_METHOD("get_slope_based_damp"), &Terrain3DTextureAsset::get_slope_based_damp);
	ClassDB::bind_method(D_METHOD("set_slope_based_normal_damp", "slope_based_normal_damp"), &Terrain3DTextureAsset::set_slope_based_normal_damp);
	ClassDB::bind_method(D_METHOD("get_slope_based_normal_damp"), &Terrain3DTextureAsset::get_slope_based_normal_damp);
	...
	ADD_GROUP("Slope", "");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "slope_blend_sharpness", PROPERTY_HINT_RANGE, "0.0, 1000.0"), "set_slope_blend_sharpness", "get_slope_blend_sharpness");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "slope_based_damp", PROPERTY_HINT_RANGE, "0.0, 1000.0"), "set_slope_based_damp", "get_slope_based_damp");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "slope_based_normal_damp", PROPERTY_HINT_RANGE, "0.0, 1000.0"), "set_slope_based_normal_damp", "get_slope_based_normal_damp");
}
