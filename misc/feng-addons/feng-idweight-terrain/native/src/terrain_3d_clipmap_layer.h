...
public:
	...
	String get_source_name() const { return _impl != nullptr ? _impl->get_source_name() : String(); }

	// ---- The shared contract, forwarded ---------------------------------------------------------
	int get_unit_count() const { return _impl != nullptr ? _impl->get_unit_count() : 0; }
	int get_size() const { return _impl != nullptr ? _impl->get_size() : _settings.shape.size; }
	int get_channel_count() const { return _impl != nullptr ? _impl->get_channel_count() : 0; }
	...
	RID get_texture_rid() const { return _impl != nullptr ? _impl->get_texture_rid() : RID(); }
	int get_texture_layer_count() const { return _impl != nullptr ? _impl->get_texture_layer_count() : 0; }
	int get_baked_channel_count() const { return _impl != nullptr ? _impl->get_baked_channel_count() : 0; }
	...
	int get_pending_bake_count() const { return _impl != nullptr ? _impl->get_pending_bake_count() : 0; }
	...
	// ---- Readings -------------------------------------------------------------------------------
	uint64_t get_state_stamp() const { return _impl != nullptr ? _impl->get_state_stamp() : 0; }
	uint64_t get_produced_texels() const { return _impl != nullptr ? _impl->get_produced_texels() : 0; }
	uint64_t get_upload_bytes() const { return _impl != nullptr ? _impl->get_upload_bytes() : 0; }
	uint64_t get_update_calls() const { return _impl != nullptr ? _impl->get_update_calls() : 0; }
	uint64_t get_idle_updates() const { return _impl != nullptr ? _impl->get_idle_updates() : 0; }
	int get_pending_jobs() const { return _impl != nullptr ? _impl->get_pending_jobs() : 0; }
	...
	Dictionary get_arm() const { return _impl != nullptr ? _impl->get_arm() : Dictionary(); }
