...
#ifndef TERRAIN3D_SURFACE_VT_INTERNAL_H
#define TERRAIN3D_SURFACE_VT_INTERNAL_H
...
// The prologue the four translation units of the surface VT service share. It is a header rather
// than a fifth .cpp because the two helpers are needed by different halves and a second copy
...
//   terrain_3d_surface_vt.cpp         the settings and the service's lifetime
//   terrain_3d_surface_vt_pages.cpp   page invalidation, the material page queue, the cell store
//   terrain_3d_surface_vt_report.cpp  the diagnostics the dock, inspector and tests read
...
#endif // TERRAIN3D_SURFACE_VT_INTERNAL_H
